...
export class DashboardPage implements OnInit {
  ...
  youthRegisteredList = [{ type: 'NCC', count: '646464', color: '#654DE7', bgColor: '#E6E1FE' }, { type: 'NSS', count: '646464', color: '#F15B43', bgColor: '#F9E2E3' }, { type: 'NYKS', count: '68754', color: '#02B6D4', bgColor: '#ecfeff' }, { type: 'BSG', count: '6567', color: '#24C45E', bgColor: '#EFFCF3' }, { type: 'Others', count: '6567', color: '#E123B8', bgColor: '#FFE5F9' }]
  ...
  orgList = [{ label: 'Government', count: '231' }, { label: 'Knowledge Institutios', count: '543' }, { label: 'Non Profits', count: '345' }, { label: 'Business', count: '123' }]
  feedbackTypes = [{ type: 'Feedback from partners', count: "231+" }, { type: 'Feedback from youth', count: "543+" }, { type: 'Average Rating', count: "543+" }]
